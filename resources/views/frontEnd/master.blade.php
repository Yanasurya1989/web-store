...
<head>
	...
	<!-- Custom-Files -->
	<link href="{{asset('webStore')}}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap css -->
	<link href="{{asset('webStore')}}/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Main css -->
	<link rel="stylesheet" href="{{asset('webStore')}}/css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="{{asset('webStore')}}/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="{{asset('webStore')}}/css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
...
<body>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="{{asset('webStore')}}/images/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m1.jpg" alt="">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m2.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m3.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m4.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m5.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m6.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								...
								<div class="col-md-8 bg-right-nut">
									<img src="{{asset('webStore')}}/images/image1.png" alt="">
								</div>
							</div>
						</div>
						<!-- //third section -->
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m7.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m8.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{asset('webStore')}}/images/m9.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="scroll">
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{asset('webStore')}}/images/k1.jpg" alt="" class="img-fluid">
										</div>
									...
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{asset('webStore')}}/images/k2.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{asset('webStore')}}/images/k3.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
					...
					<div class="join-agile text-left p-4">
						<div class="row">
							...
							<div class="col-sm-5 offerimg-w3l">
								<img src="{{asset('webStore')}}/images/off1.png" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 mt-lg-0 mt-5">
					<div class="join-agile text-left p-4">
						<div class="row ">
							...
							<div class="col-sm-5 offerimg-w3l">
								<img src="{{asset('webStore')}}/images/off2.png" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="agile-sometext py-md-5 py-sm-4 py-3">
			<div class="container">
				...
				<div class="sub-some child-momu mt-4">
					...
					<ul>
						<li>
							<img src="{{asset('webStore')}}/images/pay2.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay5.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay1.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay4.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay6.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay3.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay7.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay8.png" alt="">
						</li>
						<li>
							<img src="{{asset('webStore')}}/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<script src="{{asset('webStore')}}/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- cart-js -->
	<script src="{{asset('webStore')}}/js/minicart.js"></script>
	<script>
	...
	<!-- scroll seller -->
	<script src="{{asset('webStore')}}/js/scroll.js"></script>
	<!-- //scroll seller -->

	<!-- smoothscroll -->
	<script src="{{asset('webStore')}}/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="{{asset('webStore')}}/js/move-top.js"></script>
	<script src="{{asset('webStore')}}/js/easing.js"></script>
	<script>
	...
	<script src="{{asset('webStore')}}/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
</body>
